...
outdir="/projects/sysbio/users/cellAtlas/data/sample.exp/"
...
do
    ...
    echo "------------------------------------------"
    echo "exporting expressin matrix file for $obj"
    #echo "clusterfile $CLUSTERFILE"
    #echo "expressionfile $EXPRESSIONFILE"
    
    # run the exportSampleExpressionMatrix.py script
    python exportSampleExpressionMatrix.py -clustered_scanpy_obj $CLUSTERFILE -raw_log_scanpy_obj $EXPRESSIONFILE -output_sample_expression $outdir
